...
function addition_constructible_numbers(vplayer) {
	...
	function execute(thread) {
		...
		while (1) {
			...
			case 0:
				...
				$g[32].setTxt("Addition - Constructible Numbers", 0)
				$g[33] = (W/2)-150
				$g[34] = H/2
				$g[35] = 0
				$g[36] = 0
				$g[37] = $g[35]+aLength
				$g[38] = $g[36]
				$g[39] = $g[35]+(aLength+bLength)
				$g[40] = $g[36]
				$g[41] = new Ellipse($g[0], 0, 0, $g[1], $g[16], $g[33]-(dotRadius/2), $g[34]-(dotRadius/2), $g[35], $g[36], dotRadius, dotRadius, 0)
				$g[42] = new Arc($g[0], 0, 0, $g[1], 0, $g[33], $g[34], $g[35], $g[36], aLength, aLength, 360-45, 0)
				if ($g[42].rotateSpanAngle(90, 50, 1, 1))
				return
				$pc = 1
			case 1:
				if (wait(90))
			...
			case 2:
				...
				if ($g[43].setPt(1, $g[37], $g[38], 50, 1, 1))
				return
				$pc = 3
			case 3:
				$g[44] = new Ellipse($g[0], 0, 0, $g[1], $g[16], $g[33]-(dotRadius/2), $g[34]-(dotRadius/2), $g[37], $g[38], dotRadius, dotRadius, 0)
				if (wait(90))
				return
				$pc = 4
			case 4:
				...
				$pc = 5
			case 5:
				$g[45] = new Rectangle2($g[0], 0, VCENTRE, 0, 0, $g[33], $g[34], ($g[35]+$g[37])/2+35, ($g[36]+$g[38])/2-35, $g[1], $g[31])
				$g[45].setTxt("a", 0)
				if (wait(90))
				return
				$pc = 6
			case 6:
				$g[46] = new Arc($g[0], 0, 0, $g[1], 0, $g[33], $g[34], $g[37], $g[38], bLength, bLength, 360-45, 0)
				if ($g[46].rotateSpanAngle(90, 50, 1, 1))
				return
				$pc = 7
			case 7:
				if (wait(90))
				...
				$pc = 8
			case 8:
				$g[47] = new Line($g[0], 0, 0, $g[1], $g[33], $g[34], $g[37], $g[38], 0, 0)
				if ($g[47].setPt(1, $g[39], $g[40], 50, 1, 1))
				return
				$pc = 9
			case 9:
				$g[48] = new Ellipse($g[0], 0, 0, $g[1], $g[16], $g[33]-(dotRadius/2), $g[34]-(dotRadius/2), $g[39], $g[40], dotRadius, dotRadius, 0)
				if (wait(90))
				return
				$pc = 10
			case 10:
				...
				$pc = 11
			case 11:
				$g[49] = new Rectangle2($g[0], 0, VCENTRE, 0, 0, $g[33], $g[34], ($g[37]+$g[39])/2+175, ($g[38]+$g[40])/2-35, $g[1], $g[31])
				$g[49].setTxt("b", 0)
				if (wait(90))
				return
				$pc = 12
			case 12:
				...
				$pc = 13
			case 13:
				$g[50] = new Rectangle2($g[0], 0, VCENTRE, 0, 0, $g[33], $g[34], ($g[35]+$g[39])/2+135, ($g[36]+$g[40])/2-40, $g[1], $g[31])
				$g[50].setTxt("a + b", 0)
				returnf(0)
				continue
			}
