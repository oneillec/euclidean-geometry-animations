...
function perpendicular_to_a_line(vplayer) {
	...
	function execute(thread) {
		...
		while (1) {
			...
			case 0:
				...
				$g[36] = new Rectangle2($g[0], 0, W/2|VCENTRE, 0, 0, W/2, H/2-300, 200, 50, $g[1], 0)
				$g[36].setTxt("Perpendicular of a line through given point", 0)
				$g[37] = (W/2)-160
				$g[38] = H/2+100
				$g[39] = 0
				$g[40] = 0
			...
			case 11:
				...
				$pc = 12
			case 12:
				$g[73] = new Line($g[0], 0, 0, $g[1], $g[37], $g[38], $g[67], $g[68]-20, 0, 0)
				if ($g[73].setPt(1, $g[69], $g[70]+20, 50, 1, 1))
				return
				$pc = 13
			case 13:
				$g[74] = new Ellipse($g[0], 0, 0, $g[3], $g[18], $g[37]-(dotRadius/2), $g[38]-(dotRadius/2), $g[43], $g[42], dotRadius, dotRadius, 0)
				if (wait(90))
				return
				$pc = 14
			case 14:
				$g[71].setOpacity(0, 50, 0, 0)
				$g[74].setOpacity(0, 50, 0, 0)
				if ($g[72].setOpacity(0, 50, 0, 1))
				return
				$pc = 15
			case 15:
				returnf(0)
